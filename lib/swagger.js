...
(function() {
  ...
  SwaggerApi = (function() {
    ...
    SwaggerApi.prototype.build = function() {
      ...
      return jQuery.ajax(this.discoveryUrl, {
        type: 'GET',
        dataType: 'json',
        beforeSend: function(request) {
          _this.setRequestHeaders(request);
        },
    ...
    SwaggerApi.prototype.suffixApiKey = function(url) {
      ...
      if ((this.api_key != null) && jQuery.trim(this.api_key).length > 0 && (url != null) && (this.supportHeaderParams === null || this.supportHeaderParams === false)) {
        sep = url.indexOf('?') > 0 ? '&' : '?';
    ...
    SwaggerApi.prototype.setRequestHeaders = function(request) {
      var k, v, _ref;
    ...
    function SwaggerResource(resourceObj, api) {
      ...
      if ((resourceObj.operations != null) && (this.api.resourcePath != null)) {
        ...
        jQuery.ajax(this.url, {
          ...
          dataType: 'json',
          beforeSend: function(request) {
            _this.api.setRequestHeaders(request);
          },
          success: function(response) {
