...
(function() {
  ...
  describe('SwaggerApi', function() {
    ...
    describe('resourceLevelDiscovery', function() {
      beforeEach(function() {
        window.wordnik = new SwaggerApi({
    ...
    return describe('api key passed in header', function() {
      beforeEach(function() {
        window.wordnik = new SwaggerApi({
          discoveryUrl: 'http://petstore.swagger.wordnik.com/api/api-docs.json',
      ...
      return it("checks that headers are there", function() {
        return runs(function() {
          expect(wordnik.headers).toBeDefined();
          expect(wordnik.headers.api_key).toBeDefined();
          return expect(wordnik.headers.api_key).toEqual(window.api_key);
        });
      });
    });
  });
